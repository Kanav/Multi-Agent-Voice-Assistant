...
def search_product_catalog(query: str) -> str:
    """Search the Cart product catalog using semantic search (RAG).
...
def get_order_status(identifier: str) -> str:
    ...
    Args:
        identifier: an order ID (e.g. "ORD201") OR a customer email address
    """
...
def escalate_to_human(order_id: str, issue_summary: str, priority: str = "normal") -> str:
    ...
    Args:
        order_id:      the related order (e.g. "ORD201")
